...
public class Entity {
    ...
    protected Entity(String path, int fileNumber, int fileLimitLength, Index db) throws IOException, FileFormat {
        this(path, fileNumber, fileLimitLength, db, false);
    }

    protected Entity(String path, int fileNumber, int fileLimitLength, Index idx, boolean create) throws IOException, FileFormat {
